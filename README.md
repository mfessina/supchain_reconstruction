...
This repository contains implementations of several firm-level supply chain network reconstruction models. The models were developed and used in the research paper:
